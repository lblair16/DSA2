...
void Application::Display(void)
{
	...
	case 2:
		...
		m_pCamera->SetPositionTargetAndUpward(vector3(0.0f, 0.0f, 0.5f), vector3(0.0f), vector3(0.0f, 1.0f, 0.0f));
		break;
	case 3:
		m_pCamera->ResetCamera();
		m_pCamera->SetPerspective(false);
		m_pCamera->SetPositionTargetAndUpward(vector3(10.0f, 0.0f, 0.0f), vector3(0.0f), vector3(0.0f, 0.0f, -1.0f));
		m_pCamera->SetHorizontalPlanes(vector2(-12.0f, 12.0f));
		m_pCamera->SetVerticalPlanes(vector2(-12.0f, 12.0f));
		break;
	case 4:
		m_pCamera->ResetCamera();
		m_pCamera->SetPerspective(true);
		m_pCamera->SetPositionTargetAndUpward(vector3(0.0f, 0.0f, -15.5f), vector3(0.0f), vector3(0.0f, 1.0f, 0.0f));
		break;
	case 5:
		m_pCamera->ResetCamera();
		m_pCamera->SetPerspective(true);
	...
	case 7:
		m_pCamera->ResetCamera();
		//m_pCamera->SetPerspective(false);
		m_pCamera->SetPositionTargetAndUpward(vector3(0.0f, 0.0f, 10.0f), vector3(0.0f), vector3(0.0f, -1.0f, 0.0f));
		break;
	}
